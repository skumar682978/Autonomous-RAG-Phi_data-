...
os.environ['OPENAI_APT_KEY']= os.getenv("OpenAI_key")
    ...
    return Assistant(
        ...
        knowledge_base=AssistantKnowledge(
            vector_db=PgVector2(
                ...
                embedder=OpenAIEmbedder(model="text-embedding-3-small",api_key=os.getenv("OpenAI_key"), dimensions=1536),
            ),
            num_documents=3,
        ),
...
if __name__ == "__main__":
    ...
    llm=OpenAIChat(model=llm_model,api_key=os.getenv("OpenAI_key"))
    assistant = setup_assistant(llm)
    sample_pdf_path = "The mystic mountains.pdf"
